 ...
 * @description : [shiro 自定义的认证过滤器，用来拦截Header中携带 JWT token的请求]
...
public class JwtTokenFilter extends AccessControlFilter {
    ...
    private String  refreshToken(ServletRequest request,ServletResponse response){
        ...
        //更新 refreshToken
        redisUtil.set(SysJWTConstant.REFRESHTOKEN_PRE+username,currentTimeMillis,SysJWTConstant.REFRESHTOKEN_TIME);
        //生成 token
